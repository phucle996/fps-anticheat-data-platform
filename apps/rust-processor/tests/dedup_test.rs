...
fn create_event_with_id(id: &str) -> EventEnvelope {
    EventEnvelope {
...
fn test_deduplicate_batch_with_duplicates() {
    ...
    assert_eq!(outcome.unique_records.len(), 3, "Kỳ vọng giữ lại 3 bản ghi duy nhất");
    assert_eq!(outcome.duplicate_count, 1, "Kỳ vọng loại bỏ 1 bản ghi trùng");
