...
fn test_batch_manifest_serialization() {
    ...
    let manifest = BatchManifest {
        ...
        data_object_path: "bronze/player-stat/year=2026/month=07/day=28/pubg_player_stat_batch-test-999.parquet".to_string(),
        checksum_sha256: "8c53efdd7db58c4835214fac671639130cadcbffd533092751a5c9864e3963fb".to_string(),
    ...
    let decoded: BatchManifest = serde_json::from_str(&json_str).expect("Giải mã JSON Manifest phải thành công");
...
fn test_generate_manifest_path_hive() {
    ...
    assert_eq!(
        path,
        "manifests/year=2026/month=07/day=28/manifest_batch-test-999.json",
